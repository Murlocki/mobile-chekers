...
android {
    namespace = "com.example.mobilecheckers"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.mobilecheckers"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    sourceSets {
        getByName("main") {
            res.srcDirs(
                "src/main/res",
                "src/main/res/layouts/gameBoard",
                "src/main/res/layouts/mainScreen",
                "src/main/res/layouts/profile",
                "src/main/res/layouts/gameBoard/navigationPanel",
